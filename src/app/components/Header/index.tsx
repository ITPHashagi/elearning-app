        ...
        <div className="max-w-screen-xl flex items-center justify-between mx-auto p-4">
          ...
          <div className="flex-1 flex items-center justify-start space-x-4 mx-6">
            <div className="relative group">
              <button className="flex items-center space-x-2 px-4 py-2 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition duration-200">
                <span className="text-lg">☰</span>
                <span className="text-sm font-medium">Danh mục khóa học</span>
              </button>
              {/* Dropdown */}
              <div className="absolute left-0 mt-2 w-48 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 visible  transition-opacity duration-200 z-10">
